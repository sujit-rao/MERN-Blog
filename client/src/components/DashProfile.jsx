    ...
    const uploadImage = async () => {
        ...
        uploadTask.on(
            'state_changed', (snapshot) => {
                ...
                setImageFileUploadInProgress(progress.toFixed(0))
            },
            (error) => {
                setImageFileUploadError('Could not upload image (File must be less than 2MB)');
                setImageFileUploadInProgress(null);
                setImageFile(null);
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
                ...
                <Modal.Body>
                    <div className="text-center">
                        <HiOutlineExclamationCircle className=' h-14 w-14 text-gray-400 dark:text-gray-200 mb-4 mx-auto'><h3 className=' mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you want to delete your Account?</h3></HiOutlineExclamationCircle>
